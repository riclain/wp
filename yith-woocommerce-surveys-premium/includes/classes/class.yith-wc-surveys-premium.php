...
if( !class_exists( 'YITH_WC_Surveys_Premium' ) ){
    ...
    class YITH_WC_Surveys_Premium extends YITH_WC_Surveys{
        ...
        public function include_survey_scripts(){
            ...
            wp_enqueue_script( 'surveys_script_frontend', YITH_WC_SURVEYS_ASSETS_URL.'js/yith_surveys_frontend_premium'.$suffix.'.js', array( 'jquery' ), YITH_WC_SURVEYS_VERSION, true );
        ...
        public function save_surveys_voting(){
            ...
            if( isset( $_REQUEST['yith_surveys_ids'] ) && isset( $_REQUEST['yith_answers_ids'] ) ){
                ...
                $tot_vote = get_post_meta( $answ_id, '_yith_answer_votes', true );
                $tot_vote = $tot_vote ?  ( $tot_vote+1) : 1;
                update_post_meta( $answ_id, '_yith_answer_votes', $tot_vote );
