...
if( !class_exists( 'YITH_WC_Surveys_Frontend_Premium' ) ){
    ...
    class YITH_WC_Surveys_Frontend_Premium extends  YITH_WC_Surveys_Frontend{
        ...
        public function include_survey_styles(){
            ...
            wp_enqueue_style( 'surveys_style', YITH_WC_SURVEYS_ASSETS_URL.'css/yith_survey_frontend.css', array(), YITH_WC_SURVEYS_VERSION );
        }
        ...
        public function print_survey_in_single_product(){
            ...
            global $product;
            $all_product_survey = YITH_Surveys_Type()->get_product_surveys( $product_handle, $product->id );
