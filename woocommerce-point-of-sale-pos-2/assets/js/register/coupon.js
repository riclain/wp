	 ...
	 this.get_coupon_message = function ( msg_code) {
		...
		switch ( msg_code ) {
			case WC_COUPON_SUCCESS :
				msg = coupon_i18n[WC_COUPON_SUCCESS];
			break;
			case WC_COUPON_REMOVED :
				msg = coupon_i18n[WC_COUPON_REMOVED];
			break;
			case WC_POS_DISCOUNT_SUCCESS :
				msg = coupon_i18n[WC_POS_DISCOUNT_SUCCESS];
			break;
			default:
				msg = '';
			break;
	 ...
	 this.get_coupon_error = function ( err_code) {
		...
		switch ( err_code ) {
			...
			case E_WC_COUPON_MIN_SPEND_LIMIT_NOT_MET:
				err = sprintf( coupon_i18n[E_WC_COUPON_MIN_SPEND_LIMIT_NOT_MET], accounting.formatMoney( this.minimum_amount ) );
			break;
			case E_WC_COUPON_MAX_SPEND_LIMIT_MET:
				err = sprintf( coupon_i18n[E_WC_COUPON_MAX_SPEND_LIMIT_MET], accounting.formatMoney( this.maximum_amount ) );
			break;
