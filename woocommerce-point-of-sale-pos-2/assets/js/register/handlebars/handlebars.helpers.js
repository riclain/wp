...
Handlebars.registerHelper('displayProductItemImage', function() {
	...
	if(variation_id > 0 && v_data && v_data.image.length > 0 ){
...
Handlebars.registerHelper('displayProductItemMeta', function() {
	...
	if(variation_id > 0 && v_data){
		if(wc_pos_params.show_stock == 'yes' && v_data.stock_quantity !== ''){
		...
		if(wc_pos_params.show_stock == 'yes' && product.stock_quantity !== ''){
