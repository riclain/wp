...
jQuery(document).ready(function($) { 
	...
	APP       = window.POS_APP = {
        	...
        	APP.db.get( 'orders', order_id ).always( function( order ) {
        		...
        		if( typeof order != 'undefined' ){
        			...
        			$.each(order.line_items, function(index, item) {
        				...
        				APP.addToCart(item.product_id, quantity, variation_id, variation );
        			});
        ...
        addToCart : function (product_id, quantity, variation_id, variation, cart_item_data) {
...
*/
        ...
        add_to_cart_handler_simple : function (product_id, adding_to_cart, quantity, variation_id, variation, cart_item_data) {
        	if( wc_pos_params.instant_quantity == 'yes' && $('#modal-qt-product').length && window.openwin === false ){
