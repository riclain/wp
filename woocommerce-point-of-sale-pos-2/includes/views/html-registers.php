...
if(isset($_SERVER['HTTP_REFERER'])){
 ...
 ?>
    <h2>
        ...
        <a class="button button-primary" style="float:right;" href="<?php echo $admin_url; ?>admin.php?page=wc_pos_registers&amp;close=<?php echo $data['ID']; ?>" id="close_register">
            <?php _e('Close', 'wc_point_of_sale'); ?>
        </a>
        <?php if( get_option('wc_pos_lock_screen') == 'yes' ) { ?>
        <a class="button" style="float:right;" href="#" id="lock_register">
            <?php _e('Lock', 'wc_point_of_sale'); ?>
        </a>
        <?php } ?>
                                            ...
                                            <table class="woocommerce_order_items" cellspacing="0" cellpadding="0">
                                                <tr id="tr_order_subtotal_label">
                                                    ...
                                                    <td class="subtotal_amount">
                                                        <strong id="subtotal_amount"><?php echo wc_price(0); ?></strong>
                                                    </td>
                                                </tr>
                                                <?php /********************************/ ?>
                                                <?php
                            ...
                            <div class="tb">
                                <div class="tbr">
                                    <div class="button tips wc_pos_register_void tbc" type="button" data-tip="<?php _e('Void Order', 'wc_point_of_sale'); ?>">
                                        <?php _e('Void', 'wc_point_of_sale'); ?>
                                    </div>
                                    <div class="button tips wc_pos_register_save" type="submit" data-tip="<?php _e('Save Order', 'wc_point_of_sale'); ?>">
                                        <?php _e('Save', 'wc_point_of_sale'); ?>
                                    </div>
                                    <div class="button tips wc_pos_register_notes tbc" type="button" data-tip="<?php _e('Add A Note', 'wc_point_of_sale'); ?>">
                                        <?php _e('Note', 'wc_point_of_sale'); ?>
                                    </div>
                                    <?php 
                                    $discount = esc_attr( get_user_meta( get_current_user_id(), 'discount', true ) );
                                    if($discount != 'disable'): ?>
                                        <div class="button tips wc_pos_register_discount tbc" type="button" data-tip="<?php _e('Apply Discount', 'wc_point_of_sale'); ?>"><?php _e('Discount', 'wc_point_of_sale'); ?>
                                        </div>
                                    <?php endif; ?>
                                    <div class="button tips wc_pos_register_pay tbc" type="button" data-tip="<?php _e('Accept Payment', 'wc_point_of_sale'); ?>"><?php _e('Pay', 'wc_point_of_sale'); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
